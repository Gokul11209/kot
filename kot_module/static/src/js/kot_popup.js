odoo.define('point_of_sale.KotPopup', function(require) {
    'use strict';
     ...
     *  }
     */
    class KotPopup extends AbstractAwaitablePopup {
        constructor() {
            super(...arguments);
        }
        async willStart() {
...
//        }
    ...
    KotPopup.template = 'KotPopup';
    Registries.Component.add(KotPopup);
});
